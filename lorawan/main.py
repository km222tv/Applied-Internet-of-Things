...
# lora socket: Second part of https://docs.pycom.io/tutorials/networks/lora/lorawan-otaa/
# check_plant: By David Agerberg, Edvin Hellsing and Joel Klingberg, from 2020
# struct.pack: Help from Erik Karlsson and David M
...
##
import socket               # LoRa socket: from https://docs.pycom.io/tutorials/networks/lora/lorawan-otaa/  
import struct               # Read more at https://docs.python.org/3/library/struct.html
##
...
while True:
    ...
    # Sends the values in a structure
    package = struct.pack('>Bhh', int(humidity), int(temperature), int(moisture))
